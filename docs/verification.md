...
| AI2-Kit active-learning adapter | Unverified/code-only | Preflight and mocked tests do not demonstrate a functioning remote DeepMD → LAMMPS → VASP loop. |
...
AI2-Kit remote execution, or a real InterMat campaign. A green CI badge must
