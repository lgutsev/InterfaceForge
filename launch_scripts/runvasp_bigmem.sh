...
module purge
# Production work remains on 6.5.1 while 6.6.1 licensing/runtime is evaluated.
# For an explicit test: sbatch --export=ALL,IFACE_VASP_MODULE=vasp6/6.6.1-cpu runvasp_bigmem.sh
